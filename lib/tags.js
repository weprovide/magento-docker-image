...
module.exports = function (versions) {
    return versions.map(version => {
        const magentoSemver = coerceSemver(version.magento);
        const phpSemver = coerceSemver(version.php);

        const maxSatisfyingMagentoVersion = findMaxSatisfying(versions.map(version => coerceSemver(version.magento).toString()), `~${magentoSemver.major}.${magentoSemver.minor}`);
 ...
 * 
 * weprovide/magento:2.4         => weprovide/magento:2.4.2-php-7.4-buster
 * weprovide/magento:2.4-php-7.3 => weprovide/magento:2.4.2-php-7.3-buster
 * weprovide/magento:2.3         => weprovide/magento:2.3.6-php-7.3-buster
 * weprovide/magento:2.3-alpine  => weprovide/magento:2.3.6-php-7.3-alpine3.13
 * 
 */
